...
var ieForms = ['ingot', 'plate', 'dust', 'sheetmetal', 'slab_sheetmetal', 'storage', 'slab_storage'];
var toRemove = ['kubejs:dummy_fluid_item', // why
'immersiveengineering:lantern', 'immersiveengineering:electric_lantern', 'immersiveengineering:crate', // Obselete, supplementaries sack
...
'slope', 'alu_scaffolding', // Doesn't fit
'metal_ladder'])), _toConsumableArray(['ingot', 'plate', 'sword', 'pickaxe', 'axe', 'shovel', 'hoe', 'storage'].map(n => "immersiveengineering:".concat(n, "_steel"))), _toConsumableArray(ieForms.map(n => "immersiveengineering:".concat(n, "_electrum"))), _toConsumableArray(['nugget', 'ore'].concat(ieForms).map(n => "immersiveengineering:".concat(n, "_silver"))), ['create:crushed_uranium_ore', 'create:crushed_silver_ore', 'decorative_blocks:lattice', // Too specific
...
'limestone', 'jasper', 'slate', 'granite', // More variants
...
}, '#forge:nuggets/electrum', 'architects_palette:sunmetal_block']; // // Ore blocks to remove smelting recipes for
// let oreBlocks = [
